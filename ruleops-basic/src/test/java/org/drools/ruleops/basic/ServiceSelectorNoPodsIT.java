...
@QuarkusTest
public class ServiceSelectorNoPodsIT {
    @Inject
    ...
    public void testRules() throws Exception {
        assertThat(drools.evaluateAllRulesStateless()).contains(new Advice("Fix the Service selector","Service hello-pvdf no Pod found for selector: {app.kubernetes.io/name=hello-pvdf, app.kubernetes.io/version=1.0.0-SNAPSHOT}"));
    }
